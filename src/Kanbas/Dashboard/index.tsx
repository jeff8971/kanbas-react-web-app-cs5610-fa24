  ...
  useEffect(() => {
    if (currentUser) {
      ...
      const coursesToShow = showAllCourses
        ? courses
        : courses.filter((course) => courseIdsEnrolled.includes(course._id));

      setFilteredCourses(coursesToShow);
    }
  }, [currentUser, courses, enrollments, showAllCourses]);
            ...
            <div>
              ...
              <button
                ...
                onClick={() => {
                  ...
                  dispatch(
                    addEnrollment({ courseId: courseId, userId: currentUser._id })
                  );
                }}
              >
                Add
        ...
        <div className="row row-cols-1 row-cols-md-5 g-4">
          {filteredCourses.map((course) => {
            ...
            return (
              ...
              >
                <div
                  className="card rounded-3 overflow-hidden shadow"
                  style={{
                    height: "100%",
                    display: "flex",
